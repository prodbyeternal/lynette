...
#define InsertText(x1) ImGui::Spacing(); ImGui::NewLine(); ImGui::SameLine(19.f); ImGui::Text(x1);
#define InsertTextDisabled(x1) ImGui::Spacing(); ImGui::NewLine(); ImGui::SameLine(19.f); ImGui::TextDisabled(x1);
#define InsertCheckbox(x1,x2) ImGui::Spacing(); ImGui::NewLine(); ImGui::SameLine(19.f); ImGui::Checkbox(x1, &x2);
#define InsertSliderFloat(x1,x2,x3,x4,x5) ImGui::Spacing(); ImGui::Spacing(); ImGui::Spacing(); ImGui::Spacing(); ImGui::Spacing(); ImGui::Spacing(); ImGui::Spacing(); ImGui::Spacing(); ImGui::NewLine(); ImGui::SameLine(42.f); ImGui::PushItemWidth(159.f); ImGui::SliderFloat(x1, &x2, x3, x4, x5); ImGui::PopItemWidth();
