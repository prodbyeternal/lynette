...
// Colors
#define MENU_COLOR_CONTROL Color(80, 80, 80,255)
#define MENU_COLOR_CONTROL_BORDER Color(0, 0, 0,255)
#define MENU_COLOR_CONTROL_HOVER Color(144, 144, 144,255)
#define MENU_COLOR_CONTROL_ACTIVE Color(195, 195, 195,255)
#define MENU_COLOR_CONTROL_ACTIVE_HOVER Color(230, 230, 230,255)
...
class CLabel : public CObject
{
	...
	bool m_centered;
public:
	CLabel(std::wstring text = L"", HFont font = 0, Color color = Color(), bool centered = false);
	void Paint(int t_x = 0, int t_y = 0, float* controlheight = nullptr);
};
