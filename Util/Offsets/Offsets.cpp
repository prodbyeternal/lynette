...
void CUtil_Offsets::Init()
{
	...
	m_dwGetClientModelRenderable = U::Pattern.Find("client.dll", "56 8B F1 80 BE ? ? ? ? ? 74 53");// this is for Common Infected chams!! do not touch it
	XASSERT(m_dwGetClientModelRenderable == 0x0);// this is for Common Infected chams!! do not touch it

	m_dwCalcViewModelView = U::Pattern.Find("client.dll", "55 8B EC 83 EC 48 A1 ? ? ? ? 33 C5 89 45 FC 8B 45 10 8B 10");
	XASSERT(m_dwCalcViewModelView == 0x0);
